  ...
  const projects: Project[] = [
    {
      ...
      description:
        "A Clinical Research Center app for doctors, providing essential resources.",
      technologies: ["React Native", "API Integration", "Workflow Automation"],
      image: "crc-wb-app",
      codeURL:
        "https://play.google.com/store/apps/details?id=com.wbcrc.android&hl=en_IN",
      projectURL:
        "https://play.google.com/store/apps/details?id=com.wbcrc.android&hl=en_IN",
    },
    {
      ...
      image: "crc-web-admin",
      codeURL: "https://crc.walterbushnell.com",
      projectURL: "https://crc.walterbushnell.com",
    },
    {
      ...
      codeURL:
        "https://play.google.com/store/apps/details?id=com.apeejay.apeejayparentapp&hl=en_IN",
      projectURL:
        "https://play.google.com/store/apps/details?id=com.apeejay.apeejayparentapp&hl=en_IN",
    },
    {
      ...
      codeURL: "https://smartworkflow-ho.apeejay.edu",
      projectURL: "https://smartworkflow-ho.apeejay.edu",
    },
  ];
  ...
  const getProjectSvg = (name: string) => {
    ...
    const svgMap: Record<string, JSX.Element> = {
      ...
      "apeejay-education-app": (
        <svg viewBox="0 0 200 150" className="w-full h-full">
          <path
            d="M40,30 h120 a10,10 0 0 1 10,10 v80 a10,10 0 0 1 -10,10 h-120 a10,10 0 0 1 -10,-10 v-80 a10,10 0 0 1 10,-10 z"
            fill={color}
            opacity="0.2"
          />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="max-w-2xl mx-auto mt-4 text-muted-foreground">
            Here are some of the projects I've worked on. Each project has been
                  ...
                  <div className="absolute inset-0 bg-black/70 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div className="flex space-x-4">
                      <a
                        ...
                        className="w-10 h-10 rounded-full bg-white text-gray-800 flex items-center justify-center hover:bg-primary hover:text-white transition-colors"
                      >
                        <Eye size={18} />
                      </a>
                      <a
