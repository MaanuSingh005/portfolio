...
const ProfileSlideshow = ({
  ...
  const images = [profile6, profile7];
  ...
  return (
    ...
    <div className="relative flex items-center justify-center">
      <div className="w-81 h-81 rounded-full overflow-hidden border-2 border-white shadow-lg bg-gray-800 flex items-center justify-center">
